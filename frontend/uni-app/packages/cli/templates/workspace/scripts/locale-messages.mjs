const messages = {
  'zh-CN': {
    ...
    public_version_mismatch: 'uni-app 公开包版本必须保持一致：{versions}',
    ...
    exports_check_failed: 'uni-app package exports 检查失败：\n{violations}',
    exports_check_passed: 'uni-app package exports 检查通过（{packages}）',
    list_separator: '、',
  },
  'en-US': {
    ...
    public_version_mismatch: 'uni-app public package versions must match: {versions}',
    core_alias_forbidden:
      '{location}: Core private aliases cannot be used outside core: {specifier}',
    system_alias_forbidden:
      '{location}: System private aliases cannot be used outside system: {specifier}',
    cross_package_relative_forbidden:
      '{location}: Cross-package relative import is forbidden: {specifier}',
    ...
    exports_check_failed: 'uni-app package exports check failed:\n{violations}',
    exports_check_passed: 'uni-app package exports check passed ({packages})',
    list_separator: ', ',
  },
}
