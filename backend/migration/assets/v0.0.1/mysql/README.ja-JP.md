...
- システムパラメーターとパラメーター管理は基本管理に配置します。前者は専用フォーム、後者は同じ設定データのキー、型、値を編集します。データバックアップとデータアーカイブには、それぞれ設定、履歴、復元履歴を直接配置します。システム運用には稼働監視、実行ログ、キャッシュ照会、データベースマイグレーション履歴（旧アップグレード履歴）を配置し、開発ツールには API ドキュメントとコード生成を表示します。辞書データは基本管理の非表示ページ `91010700`、コード生成の非表示設定・プレビューページは開発ツール配下の `91110300` から `91110600`、ボタンは `91110201` から `91110209` です。
