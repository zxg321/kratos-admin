...
type BaseAPI struct {
	...
	McpStatus      int32                 `gorm:"column:mcp_status;type:smallint;not null;index:idx_base_api_mcp_status,priority:1;comment:MCP工具状态：枚举【Status】" json:"mcp_status"`         // MCP工具状态：枚举【Status】
	AgentStatus    int32                 `gorm:"column:agent_status;type:smallint;not null;index:idx_base_api_agent_status,priority:1;comment:Agent工具状态：枚举【Status】" json:"agent_status"` // Agent工具状态：枚举【Status】
