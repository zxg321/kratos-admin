...
type BaseAPILog struct {
	...
	Result       int32     `gorm:"column:result;not null;index:idx_base_api_log_result_occurred_at,priority:2;comment:结果：枚举【BaseLogResult】" json:"result"`                                                                                                                                                             // 结果：枚举【BaseLogResult】
