...
type BaseRedactStoragePolicy struct {
	...
	Status     int32                 `gorm:"column:status;type:smallint;not null;index:idx_base_redact_storage_policy_status,priority:1;comment:状态：枚举【Status】" json:"status"`                                                        // 状态：枚举【Status】
	...
	DeletedAt  soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint;not null;uniqueIndex:unique_base_redact_storage_policy,priority:5;comment:删除时间;softDelete:milli" json:"deleted_at"`                                        // 删除时间
}
