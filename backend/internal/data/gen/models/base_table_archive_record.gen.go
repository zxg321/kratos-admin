...
type BaseTableArchiveRecord struct {
	...
	CutoffAt         time.Time `gorm:"column:cutoff_at;not null;comment:归档截止时间" json:"cutoff_at"`                                                                                                                                                        // 归档截止时间
	...
	Status           int32     `gorm:"column:status;not null;index:idx_base_table_archive_record_source_table_status,priority:3;index:idx_base_table_archive_record_table_status,priority:2;comment:归档状态：枚举【BaseTableArchiveRecordStatus】" json:"status"` // 归档状态：枚举【BaseTableArchiveRecordStatus】
