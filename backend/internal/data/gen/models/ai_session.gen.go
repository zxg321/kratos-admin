...
type AiSession struct {
	...
	Terminal  int32                 `gorm:"column:terminal;type:tinyint;not null;index:idx_ai_session_tenant_id_user_id_terminal_updated_at,priority:3;comment:终端类型：枚举【Terminal】" json:"terminal"` // 终端类型：枚举【Terminal】
	Title     string                `gorm:"column:title;type:varchar(100);not null;comment:会话标题" json:"title"`                                                                                     // 会话标题
	Summary   string                `gorm:"column:summary;type:varchar(255);not null;comment:会话摘要" json:"summary"`                                                                                 // 会话摘要
	CreatedAt time.Time             `gorm:"column:created_at;type:datetime;not null;comment:创建时间" json:"created_at"`                                                                               // 创建时间
	UpdatedAt time.Time             `gorm:"column:updated_at;type:datetime;not null;index:idx_ai_session_tenant_id_user_id_terminal_updated_at,priority:4;comment:更新时间" json:"updated_at"`         // 更新时间
