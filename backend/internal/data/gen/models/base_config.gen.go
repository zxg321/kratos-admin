...
type BaseConfig struct {
	...
	Type      int32                 `gorm:"column:type;type:smallint;not null;comment:配置类型：1文本，2图片，3富文本，4字典，5布尔，6表单" json:"type"`                                             // 配置类型：1文本，2图片，3富文本，4字典，5布尔，6表单
	...
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint;not null;uniqueIndex:unique_base_config,priority:3;comment:删除时间;softDelete:milli" json:"deleted_at"` // 删除时间
}
