...
// BaseTableBackup mapped from table <base_table_backup>
type BaseTableBackup struct {
	...
	SourceName     string                `gorm:"column:source_name;type:character varying(64);not null;uniqueIndex:unique_base_table_backup,priority:2;comment:数据源名称" json:"source_name"` // 数据源名称
	...
	RetentionCount int32                 `gorm:"column:retention_count;type:integer;not null;comment:保留备份数量" json:"retention_count"`                                                      // 保留备份数量
	Status         int32                 `gorm:"column:status;type:integer;not null;index:idx_base_table_backup_status,priority:1;comment:状态：枚举【Status】" json:"status"`                   // 状态：枚举【Status】
	...
	DeletedAt      soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint;not null;uniqueIndex:unique_base_table_backup,priority:1;comment:删除时间;softDelete:milli" json:"deleted_at"`  // 删除时间
}
