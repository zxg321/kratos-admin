...
type BaseTenantProject struct {
	...
	Status    int32                 `gorm:"column:status;type:tinyint;not null;index:idx_base_tenant_project_tenant_id_status,priority:2;comment:状态：枚举【Status】" json:"status"`                                                                            // 状态：枚举【Status】
	...
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint unsigned;not null;uniqueIndex:unique_base_tenant_project,priority:3;index:idx_base_tenant_project_tenant_id_status,priority:3;comment:软删除时间;softDelete:milli" json:"deleted_at"` // 软删除时间
}
