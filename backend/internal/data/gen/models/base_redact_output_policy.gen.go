...
type BaseRedactOutputPolicy struct {
	...
	Mode        int32                 `gorm:"column:mode;type:smallint;not null;comment:处理模式：枚举【BaseRedactOutputPolicyMode】" json:"mode"`                                                                                                      // 处理模式：枚举【BaseRedactOutputPolicyMode】
	...
	Status      int32                 `gorm:"column:status;type:smallint;not null;index:idx_base_redact_output_policy_operation,priority:2;comment:状态：枚举【Status】" json:"status"`                                                               // 状态：枚举【Status】
	...
	DeletedAt   soft_delete.DeletedAt `gorm:"column:deleted_at;type:bigint;not null;uniqueIndex:unique_base_redact_output_policy,priority:5;comment:删除时间;softDelete:milli" json:"deleted_at"`                                        // 删除时间
}
