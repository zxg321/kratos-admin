...
type BaseFile struct {
	...
	Provider      int32                 `gorm:"column:provider;not null;comment:存储供应商" json:"provider"`                                                                                                                                                         // 存储供应商
	...
	CreatedAt     time.Time             `gorm:"column:created_at;not null;index:idx_base_file_tenant_created_at,priority:2;comment:创建时间" json:"created_at"`                                                                                                 // 创建时间
