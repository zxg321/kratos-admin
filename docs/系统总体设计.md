...
| `frontend/admin/apps/admin` | 组合 core 与 System 的默认管理端宿主。 | 私有包 `@liujitcn/kratos-admin`、`backend/web/admin` |
| `frontend/uni-app` | 首页、登录、我的、资料、设置、WebView 和 AI 的 uni-app 应用端。 | `@liujitcn/kratos-uni-app`、`backend/web/uni-app` |
